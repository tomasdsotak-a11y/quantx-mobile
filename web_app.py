...
def home():
    ...
    if request.method == 'POST':
        try:
            ...
            behav = run_simulation_variant(h_stats, a_stats, "NEUTRAL", 1.0, {'home_attacks': 1.0, 'away_attacks': 1.0, 'aggression_stakes': 1.0, 'fitness_fatigue': 1.0})
            report = {
                ...
                "b_xg_h": "1.7", "b_xg_a": "1.1", "behav_xg_h": f"{behav['odds'][0]*0.4:.2f}", "behav_xg_a": f"{behav['odds'][2]*0.3:.2f}",
                "b_shots": "20", "behav_shots": f"{behav['shots_total']}",
                "b_sot_h": "6", "behav_sot_h": "4", "b_sot_a": "4", "behav_sot_a": "3",
                "b_saves_h": "3", "behav_saves_h": "2", "b_saves_a": "4", "behav_saves_a": "3",
            ...
            print(f"Error: {e}")
    return render_template_string(HTML_TEMPLATE, schedule=GLOBAL_MATCH_DATABASE, report=report, logs=logs)
