...
# =====================================================================
# 1. LIVE MASTER SQUAD STAT PERFORMANCE MATRIX (GLOBAL SQUAD MATRIX)
# =====================================================================
TEAM_STAT_DATABASE = {
    # Nations
    ...
    "Mamelodi Sundowns": {"base_xg": 1.58, "shots_avg": 12.9, "shots_conceded_avg": 10.3, "shot_accuracy": 0.35, "gk_save_pct": 0.71, "corners_avg": 5.1, "club_cards_avg": 1.9, "offsides_avg": 1.5, "goal_kicks_avg": 7.5},
...
# =====================================================================
# 2. MASTER GLOBAL DATABASE SYSTEM (ALL PATHWAYS SYNCED)
# =====================================================================
GLOBAL_MATCH_DATABASE = [
    # --- 1. WORLD CUP ENTIRE PYRAMID GRID (GROUPS A TO L INTEGRATED) ---
    ...
    {"id": 3, "cat": "WC", "home": "Qatar", "away": "Switzerland", "filter1": "Group B", "filter2": "Switzerland", "filter3": "13/06", "city": "San Francisco", "hours_to_kick": 52, "country": "USA"},
    {"id": 4, "cat": "WC", "home": "Haiti", "away": "Scotland", "filter1": "Group C", "filter2": "Scotland", "filter3": "13/06", "city": "Boston", "hours_to_kick": 54, "country": "USA"},
    {"id": 5, "cat": "WC", "home": "Brazil", "away": "Morocco", "filter1": "Group C", "filter2": "Brazil", "filter3": "13/06", "city": "New York", "hours_to_kick": 58, "country": "USA"},
    {"id": 6, "cat": "WC", "home": "USA", "away": "Paraguay", "filter1": "Group D", "filter2": "USA", "filter3": "12/06", "city": "Los Angeles", "hours_to_kick": 32, "country": "USA"},
    {"id": 7, "cat": "WC", "home": "Australia", "away": "Türkiye", "filter1": "Group D", "filter2": "Australia", "filter3": "13/06", "city": "Vancouver", "hours_to_kick": 56, "country": "Canada"},
    ...
    {"id": 16, "cat": "Leagues", "home": "Real Madrid", "away": "Barcelona", "filter1": "Spain", "filter2": "La Liga (Tier 1)", "filter3": "Round 34", "date": "13/06", "city": "Madrid", "hours_to_kick": 40, "country": "Spain"},
    {"id": 17, "cat": "Leagues", "home": "Real Zaragoza", "away": "Levante", "filter1": "Spain", "filter2": "Segunda División (Tier 2)", "filter3": "Round 38", "date": "14/06", "city": "Zaragoza", "hours_to_kick": 62, "country": "Spain"},
    {"id": 18, "cat": "Leagues", "home": "Deportivo La Coruña", "away": "Castellón", "filter1": "Spain", "filter2": "Primera Federación (Tier 3)", "filter3": "Round 38", "date": "14/06", "city": "A Coruna", "hours_to_kick": 64, "country": "Spain"},
    {"id": 19, "cat": "Leagues", "home": "Slavia Prague", "away": "Sparta Prague", "filter1": "Czechia", "filter2": "Chance Liga (Tier 1)", "filter3": "Round 30", "date": "11/06", "city": "Prague", "hours_to_kick": 6, "country": "Czechia"},
    ...
    {"id": 29, "cat": "Elite", "home": "South Africa", "away": "Morocco", "filter1": "AFCON", "filter2": "Group Stage", "filter3": "Matchday 1", "date": "17/06", "city": "Johannesburg", "hours_to_kick": 70, "country": "Africa"},
...
# =====================================================================
# 4. LUXURY PRESENTATION LAYER DESIGN (HTML/CSS)
# =====================================================================
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang='en'>
